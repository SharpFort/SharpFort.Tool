...
namespace SharpFort.Tool.Web
{
    ...
    public class SharpFortToolWebModule : AbpModule
    {
        ...
        public override Task ConfigureServicesAsync(ServiceConfigurationContext context)
        {
            ...
            {
                options.ConventionalControllers.Create(typeof(SharpFortToolApplicationModule).Assembly, options => options.RemoteServiceName = "tool");
                //统一前缀
            ...
            //Swagger
            context.Services.AddYiSwaggerGen<SharpFortToolWebModule>(options =>
            {
